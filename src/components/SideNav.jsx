...
import { Home, Users, Calendar, FileText, Settings, UserCheck, Activity, Pill, X } from 'lucide-react';
                ...
                <div className="p-4">
                    <nav className="space-y-2">
                        {menuItems.map((item, index) => (
                            <button
                                key={index}
                                className={`w-full flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors ${item.active
